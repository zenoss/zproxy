...
ifndef CHECK_TOOLS
	...
	# iterating over a list of required build tools.  This can go away
	# once we have a configure script in place.
    #
...
ifeq "$(ZBUILD_VERBOSE)" "1"
    ...
    define echobothl
        echo "  $(TIME_TAG) "$(1) | $(TEE) -a $(ABS_BUILD_LOG)
    endef
else
    #--------------------------------------------------------------
